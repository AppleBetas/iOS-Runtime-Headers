...
@property (assign,nonatomic) BOOL selectedRightCrown;                                     //@synthesize selectedRightCrown=_selectedRightCrown - In the implementation block
...
-(void)selectedCrownOnRight:(BOOL)arg1 ;
-(BOOL)selectedRightCrown;
-(void)setSelectedRightCrown:(BOOL)arg1 ;
