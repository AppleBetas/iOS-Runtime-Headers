...
@interface COSBackupManager : NSObject {
	...
	BOOL _isCompatibleBackupListCurrent;
	BOOL _isCompatiblePairedDeviceListCurrent;
...
@property (assign,nonatomic) BOOL isCompatibleBackupListCurrent;                    //@synthesize isCompatibleBackupListCurrent=_isCompatibleBackupListCurrent - In the implementation block
@property (assign,nonatomic) BOOL isCompatiblePairedDeviceListCurrent;              //@synthesize isCompatiblePairedDeviceListCurrent=_isCompatiblePairedDeviceListCurrent - In the implementation block
...
-(void)setIsCompatibleBackupListCurrent:(BOOL)arg1 ;
-(BOOL)isCompatiblePairedDeviceListCurrent;
-(void)setIsCompatiblePairedDeviceListCurrent:(BOOL)arg1 ;
-(id)init;
-(void)reset;
