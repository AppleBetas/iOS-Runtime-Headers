...
@property (assign,nonatomic) unsigned long long screenStyle;                                         //@synthesize screenStyle=_screenStyle - In the implementation block
...
-(void)setScreenStyle:(unsigned long long)arg1 ;
