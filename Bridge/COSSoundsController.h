...
@class UIImage, PSSpecifier, NPSDomainAccessor, NSString;
...
-(void)updateTapToSpeakVisibility;
-(void)updateVolumeSliderWithHighlightedDownGlyph:(BOOL)arg1 ;
-(void)updateHapticSliderWithHighlightedDownGlyph:(BOOL)arg1 ;
