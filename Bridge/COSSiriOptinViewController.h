...
@interface COSSiriOptinViewController : COSOptinViewController <COSUnifiedFYIOptinController> {
	...
	BOOL _languageSupported;

}

@property (assign,nonatomic) BOOL languageSupported;                //@synthesize languageSupported=_languageSupported - In the implementation block
...
-(void)setLanguageSupported:(BOOL)arg1 ;
-(id)init;
-(id)titleString;
-(id)imageResource;
@end
